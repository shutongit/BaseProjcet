...
- (void)commonInit
{
    ...
    
    {
        ...
        self.isEvent = dotView.hidden = YES;
    }
...
- (void)didTouch
{
    ...
    [self.calendarManager.dataSource calendarDidDateSelected:self.calendarManager date:self.date isEvent:self.isEvent];
...
- (void)reloadData
{
   self.isEvent = dotView.hidden = ![self.calendarManager.dataSource calendarHaveEvent:self.calendarManager date:self.date];
