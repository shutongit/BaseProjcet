...
//    [self addrightItem:@"Photos.png"];
    [self addNavigationItemWithImageNames:@[@"dingwei"] isLeft:NO target:self tags:@[@100]];
...
- (void)InitScan
{
    ...
    readview = [[QRCodeReaderView alloc]initWithFrame:CGRectMake(0, 64, DeviceMaxWidth, DeviceMaxHeight-TabHeight)];
...
{
    if (self.scancodeString) {
        self.scancodeString(str);
    }
