...
{
    BaseSearchBarView *searchView = [[BaseSearchBarView alloc]initWithFrame:CGRectMake(20, NavHeight, KScreenWidth-40, 44)];
...
- (void)createMapView
{
    self.mapView = [[MAMapView alloc] initWithFrame:CGRectMake(0, NavHeight + 44, KScreenWidth, KScreenHeight - NavHeight - 44)];
