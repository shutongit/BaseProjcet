...
#import "BaseRootWebViewController.h"
#import <WebKit/WebKit.h>

@interface BaseRootWebViewController ()<WKNavigationDelegate,WKUIDelegate>
{
...
@implementation BaseRootWebViewController
...
-(void)initWKWebView
{
    ...
    _wkwebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, NavHeight, KScreenWidth, KScreenHeight-NavHeight) configuration:configuration];
...
//        [self addNavigationItemWithTitles:@[@"返回",@"关闭"] isLeft:YES target:self tags:@[@2000,@2001]];
...
#ifdef kiOS9Later
//        [self addNavigationItemWithTitles:@[@"返回"] isLeft:YES target:self tags:@[@2001]];
#else
